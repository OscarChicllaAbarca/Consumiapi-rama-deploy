        ...
        <div class="row g-0">
                    ...
                    <div :class="{'d-none d-md-block': !showFilters}">
                        <div class="row g-2">
                            ...
                            <div class="col-12 col-md-6 col-lg-3">
                                ...
                                <input type="text" id="ubicacion" v-model="ubicacion" @change="obtenerTomas" 
                                    class="form-control form-control-sm rounded-pill">
                            </div>
                            <div class="col-12 col-md-6 col-lg-3">
                                <label for="producto" class="form-label small mb-1">Producto:</label>
                                <input type="text" id="producto" v-model="producto" @change="debounceObtenerTomas" 
                                    class="form-control form-control-sm rounded-pill">
                            </div>
                            
                            <div class="col-12 mt-2">
                                <button @click="exportarPorCodigo" class="btn btn-sm btn-primary rounded-pill w-100 w-md-auto" 
                                    :disabled="isExporting || !codigoInventario">
            ...
            <div class="col-12 d-block d-lg-none mb-3">
                ...
                <div v-else class="product-cards">
                    <div v-for="(item, index) in tomas" :key="index" 
                        class="product-card mb-3 p-3 rounded-4 shadow-sm"
                        :class="{ 'active-card': selectedItem === item }"
                ...
                <div class="mobile-pagination d-flex justify-content-between align-items-center mt-3">
                    <button @click="prevPage" class="btn btn-sm btn-light rounded-circle" 
                        :disabled="currentPage === 0">
                        <i class="fas fa-chevron-left"></i>
                    </button>
                    <span class="pagination-info">{{ currentPage + 1 }} / {{ totalPages || 1 }}</span>
                    <button @click="nextPage" class="btn btn-sm btn-light rounded-circle"
            ...
            <div class="col-12 d-none d-lg-block mb-3">
                <div class="table-container rounded-4 shadow-sm overflow-hidden">
                    ...
                    <table v-else class="table table-bordered table-hover m-0">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in tomas" :key="index" 
                                @click="selectRow(item)" 
                    ...
                    <div class="modal-body">
                        <form @submit.prevent="updateItem">
                            <div class="mb-3">
                                ...
                                <input type="text" id="edit-producto" v-model="itemToEdit.producto" 
                                    class="form-control rounded-pill" required>
                            </div>
                            <div class="mb-3">
                                <label for="edit-descripcion" class="form-label small">Descripción:</label>
                                <input type="text" id="edit-descripcion" v-model="itemToEdit.descripcionProducto" 
                                    class="form-control rounded-pill">
                            </div>
                            <div class="row mb-3">
                                <div class="col-6">
                                    <label for="edit-cantidad" class="form-label small">Cantidad:</label>
                                    <input type="number" id="edit-cantidad" v-model="itemToEdit.cantidad" 
                                        class="form-control rounded-pill" required min="0.0" step="0.01">
                                </div>
                                <div class="col-6">
                                    <label for="edit-unidad" class="form-label small">Unidad de medida:</label>
                                    <input type="text" id="edit-unidad" v-model="itemToEdit.unidadMedidaBase" 
                                        class="form-control rounded-pill">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-6">
                                    ...
                                    <input type="text" id="edit-ubicacion" v-model="itemToEdit.ubicacion" 
                                        class="form-control rounded-pill">
                                </div>
                                <div class="col-6">
                                    <label for="edit-lote" class="form-label small">Lote:</label>
                                    <input type="text" id="edit-lote" v-model="itemToEdit.lote" 
                                        class="form-control rounded-pill">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="edit-observacion" class="form-label small">Observación:</label>
                                <textarea id="edit-observacion" v-model="itemToEdit.observacion" 
