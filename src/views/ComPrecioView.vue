<template>
        ...
        <div class="stat-cards" v-if="totals && datosFiltrados.length > 0">
            <div class="stat-card">
                ...
                <div class="stat-card-row">
                    ...
                    <div class="stat-value">S/. {{ formatearPrecio(sumaConciliado()) }}</div>
                    <div class="stat-value">
                        <div class="progress-bar-container">
    ...
    export default {
        ...
        data() {
            return {
                ...
                codigosInventario: ['INVINOP202543', 'INVCICL202532', 'INVCICL202554', 'INVCICL202565', 'INVCICL202576', 'INVCICL202521',
                 'INVINOP202587', 'INVCICL202598', 'INVCICL2025109', 'INVCICL20251110','INVCICL20251211','INVCICL20251312','INVCICL20251413','INVCICL20251514','INVCONT20251715'],
        ...
        methods: {
            ...
            calcularPorcentajeValor() {
                return (this.sumaConciliado() / this.sumaTotalInventarioEwm()) * 100;
            },
            getProgressBarColor() {
  ...
  * {
  ...
  .filtro-item {
      flex: 1 1 calc(25% - 1.25rem); /* 4 elementos por fila en lugar de 3 */
      min-width: 180px;
  ...
  .inventario-table th {
      background-color: #0c534c; /* Color sólido */
      color: white;
      font-weight: 600;
      position: sticky;
      top: 0;
  ...
  .modal-contenido {
      ...
      width: 90%;
      max-width: 800px; /* Aumentado para vista web */
      max-height: 90vh;
      overflow-y: auto;
  ...
  .form-group {
      flex: 1 1 calc(33.333% - 20px); /* 3 elementos por fila en lugar de 2 */
      min-width: 200px;
  }
